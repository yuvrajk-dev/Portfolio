        ...
        >
          {cards.map((card, index) => (
            <motion.div
              ...
              className="group flex flex-col gap-5 rounded-2xl border border-black/10 bg-(--bg-light) p-6 shadow-(--shadow-s) transition-shadow duration-100 hover:shadow-(--shadow-l)"
            >
